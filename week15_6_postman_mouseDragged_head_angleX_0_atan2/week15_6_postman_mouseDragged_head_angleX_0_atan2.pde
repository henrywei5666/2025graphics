//week15_6_postman_mouseDragged_head_angleX_0_atan2
//修改自 week15_5_postman_mouseDragged_head_angleX_0_atan2
...
float [] posX = { 232, 185, 290, 357, 220, 260}; //從void draw()
float [] posy = { 200, 261, 262, 259, 375, 372}; //找到
void mouseDragged(){
  //要把原本 mouseX 的左右移動,改成像IK的轉動
  //從 void draw()找到頭「掛的位置」+232,+200
  float dx = mouseX-232 , dy = mouseY-200; //減掉座標
